			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
			                  							...
			                  							<td style=""><?php echo $category_detail->category_name; ?></td>
			                  							<td style=><img src="../img/category/<?php echo $category_detail->id; ?>/<?php echo $category_detail->img_cover; ?>" style="width:200px;"></td>
			                  							<td style="">
														  <?php if(!empty($category_detail->updated)) {
																  echo date("d/m/Y", strtotime( $category_detail->updated ) ); 
															} else {
																echo '-';
															}
														  ?>
			                  							...
			                  							<td>
			                  								<button type="button" class="btn btn-round btn-warning btn-sm" onclick="window.location.href = 'category_edit.php?id=<?php echo $category_detail->id; ?>';"><i class="icon wb-pencil" aria-hidden="true"></i></button>
			                  							</td> 
			                  						</tr>
			                  						<?php
			                  							$i++;
