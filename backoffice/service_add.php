			            ...
			            <div class="panel-body container-fluid">
			              	<form id="serviceAdd" name="serviceAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                ...
				                <div class="form-group" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="name" name="name_en" placeholder="Name" required>
				                </div>
								<div class="form-group" data-plugin="formMaterial">
									<label class="form-control-label" for="category">หมวดหมู่</label>
									...
									<?php foreach ($category_list as $category_detail) : ?>
										<option value="<?php echo $category_detail->id; ?>"><?php echo $category_detail->category_name; ?></option>
									<?php endforeach ?>
									</select>
								</div>
