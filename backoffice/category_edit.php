...
<head>
	...
	<title>หมวดหมู่การบริการ | Goodup </title>
...
<body class="animsition dashboard">
	...
	$category_detail = category_detail($_GET['id']);
	?>
			            ...
			            <div class="panel-body container-fluid">
							...
							<div class="row">
				                <div class="form-group col-lg-12" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="urlname" name="urlname" value="<?php echo $category_detail->url_name; ?>" required>
				                </div>
				                <div class="form-group col-lg-12" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="keyword">Keyword</label>
				                  	<input type="text" class="form-control" id="keyword" name="keyword" value="<?php echo $category_detail->keyword; ?>" required>
				                </div>
				                <div class="form-group col-lg-12" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">ชื่อหมวดหมู่</label>
				                  	<input type="text" class="form-control" id="name" name="name" value="<?php echo $category_detail->category_name; ?>" required>
				                </div>
				                <div class="form-group col-lg-12" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">ชื่อหมวดหมู่ (EN)</label>
				                  	<input type="text" class="form-control" id="name_en" name="name_en" value="<?php echo $category_detail->category_name_en; ?>" required>
				                </div>
								<div class="form-group col-lg-12" data-plugin="formMaterial">
									<label class="form-control-label" for="guarantee">รายละเอียด</label>
									<textarea class="form-control summernote" rows="4" placeholder="Detail" id="editor" name="description">
                                        <?php echo $category_detail->description; ?>
                                    </textarea>
								</div>
								<div class="form-group col-lg-12" data-plugin="formMaterial">
									<label class="form-control-label" for="guarantee">รายละเอียด (EN)</label>
									<textarea class="form-control summernote" rows="4" placeholder="Detail" id="editor_en" name="description_en">
                                        <?php echo $category_detail->description_en; ?>
                                    </textarea>
								</div>
								<div class="form-group form-material-file col-lg-12" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">รูปภาพหน้าปก</label>
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="../img/category/<?php echo $category_detail->id; ?>/<?php echo $category_detail->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
				                ...
				                <div class="text-right">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = 'category.php';">
