...
<body class="animsition dashboard">
		...
		<div class="page-content container-fluid">
	      	...
	      	<div class="panel">
		        <div class="panel-heading">
		          	<h3 class="panel-title">งานบริการ</h3>
		        </div>
			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
			                  							...
			                  							<td style=""><?php echo $service_detail->service_name; ?></td>
			                  							<td style=""><?php echo $service_detail->cate_name; ?></td>
														  <td style=><img src="../img/service/<?php echo $service_detail->id; ?>/<?php echo $service_detail->img_cover; ?>" style="width:200px;"></td>
			                  							<td style="">
														  <?php if(!empty($service_detail->updated)) {
																  echo date("d/m/Y", strtotime( $service_detail->updated ) ); 
															} else {
																echo '-';
															}
														  ?>
			                  							...
			                  							<td>
			                  								<button type="button" class="btn btn-round btn-warning btn-sm" onclick="window.location.href = 'service_edit.php?id=<?php echo $service_detail->id; ?>';"><i class="icon wb-pencil" aria-hidden="true"></i></button>
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-body">
					<h4>คุณต้องการลบการบริการใช่หรือไม่ ?</h4>
				</div>
				<div class="modal-footer">
					<input type="hidden" id="sid" name="sid">
					<button type="button" class="btn btn-success" onclick="deleteService()"><i class="fa fa-check"></i> ยืนยัน</button>
     ...
     function deleteService()
    {
   		$.ajax({
		  	type 	: 'POST',
		  	url 	: 'queryDB.php',
		  	data 	: {sid:$('#sid').val(), action:'delService'},
