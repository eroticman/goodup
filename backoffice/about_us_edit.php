...
<head>
	...
	<title>เกี่ยวกับเรา | Goodup </title>
...
<body class="animsition dashboard">
	...
	<?php 
    include('included_img_about.php');
	...
	$about_us_detail = about_us_detail($_GET['id']);
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">แก้ไขข้อมูลเกี่ยวกับเรา</h3>
			            </div>
			            <div class="panel-body container-fluid">
			              	<form id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
				                <div class="form-group" data-plugin="formMaterial">
				                  	...
				                  	<input type="text" class="form-control" id="name" name="name" value="<?php echo $about_us_detail->about_name; ?>" required>
				                </div>
								<div class="form-group" data-plugin="formMaterial">
									<label class="form-control-label" for="description">ประวัติความเป็นมา</label>
									<textarea class="form-control summernote" rows="4" placeholder="Detail" id="editor" name="history_desc">
                                        <?php echo $about_us_detail->history_desc; ?>
                                    </textarea>
								</div>
								<div class="form-group" data-plugin="formMaterial">
									<label class="form-control-label" for="his">ประวัติความเป็นมา (EN)</label>
									<textarea class="form-control summernote" rows="4" placeholder="Detail" id="editor_en" name="history_desc_en">
                                        <?php echo $about_us_detail->history_desc_en; ?>
                                    </textarea>
								</div>
								<div class="form-group" data-plugin="formMaterial">
									<label class="form-control-label" for="description">พันธกิจ</label>
									<textarea class="form-control summernote" rows="4" placeholder="Detail" id="mission" name="mission_desc">
                                        <?php echo $about_us_detail->mission_desc; ?>
                                    </textarea>
								</div>
								<div class="form-group" data-plugin="formMaterial">
									<label class="form-control-label" for="his">พันธกิจ (EN)</label>
									<textarea class="form-control summernote" rows="4" placeholder="Detail" id="mission_en" name="mission_desc_en">
                                        <?php echo $about_us_detail->mission_desc_en; ?>
                                    </textarea>
								</div>
								<div class="form-group" data-plugin="formMaterial">
									<label class="form-control-label" for="description">นโยบาย</label>
									<textarea class="form-control summernote" rows="4" placeholder="Detail" id="policy" name="policy_desc">
                                        <?php echo $about_us_detail->policy_desc; ?>
                                    </textarea>
								</div>
								<div class="form-group" data-plugin="formMaterial">
									<label class="form-control-label" for="his">นโยบาย (EN)</label>
									<textarea class="form-control summernote" rows="4" placeholder="Detail" id="policy_en" name="policy_desc_en">
                                        <?php echo $about_us_detail->policy_desc_en; ?>
                                    </textarea>
								</div>
								<div class="form-group form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">รูปภาพ</label>
			                      	<input type="file" id="covImg" name="covImg" data-plugin="dropify" data-default-file="<?php echo '../img/about_us/cover/' . $about_us_detail->img_cover; ?>" data-allowed-file-extensions="png jpg"/>
				                ...
				                <div class="text-right">
				                	<input type="hidden" name="about_us_id" value="<?php echo $about_us_detail->id; ?>">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = 'about_us.php';">
